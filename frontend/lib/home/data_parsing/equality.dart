...
Equality equalityFromJson(String str) => Equality.fromJson(json.decode(str));

String equalityToJson(Equality data) => json.encode(data.toJson());
...
class Equality {
  ...
  factory Equality.fromJson(Map<String, dynamic> json) => Equality(
