...
WageClaim wageClaimFromJson(String str) => WageClaim.fromJson(json.decode(str));

String wageClaimToJson(WageClaim data) => json.encode(data.toJson());
...
class WageClaim {
  ...
  factory WageClaim.fromJson(Map<String, dynamic> json) => WageClaim(
