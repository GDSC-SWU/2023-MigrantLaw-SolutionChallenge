...
SafetyInsurance safetyInsuranceFromJson(String str) => SafetyInsurance.fromJson(json.decode(str));

String safetyInsuranceToJson(SafetyInsurance data) => json.encode(data.toJson());

class SafetyInsurance {
  SafetyInsurance({
  ...
  factory SafetyInsurance.fromJson(Map<String, dynamic> json) => SafetyInsurance(
