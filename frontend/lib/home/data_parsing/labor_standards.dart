...
LaborStandards laborStandardsFromJson(String str) => LaborStandards.fromJson(json.decode(str));

String laborStandardsToJson(LaborStandards data) => json.encode(data.toJson());
...
class LaborStandards {
  ...
  factory LaborStandards.fromJson(Map<String, dynamic> json) => LaborStandards(
...
class Hilarious {
  ...
  factory Hilarious.fromJson(Map<String, dynamic> json) => Hilarious(
    empty: Ambitious.fromJson(json["별표단위"]),
  );
