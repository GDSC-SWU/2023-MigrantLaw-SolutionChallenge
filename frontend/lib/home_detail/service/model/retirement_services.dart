...
RetirementServices retirementServicesFromJson(String str) => RetirementServices.fromJson(json.decode(str));

String retirementServicesToJson(RetirementServices data) => json.encode(data.toJson());

class RetirementServices {
  RetirementServices({
  ...
  factory RetirementServices.fromJson(Map<String, dynamic> json) => RetirementServices(
