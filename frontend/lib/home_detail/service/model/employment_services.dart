...
//
//     final employmentServices = employmentServicesFromJson(jsonString);

import 'dart:convert';

EmploymentServices employmentServicesFromJson(String str) => EmploymentServices.fromJson(json.decode(str));

String employmentServicesToJson(EmploymentServices data) => json.encode(data.toJson());
...
class EmploymentServices {
  ...
  factory EmploymentServices.fromJson(Map<String, dynamic> json) => EmploymentServices(
