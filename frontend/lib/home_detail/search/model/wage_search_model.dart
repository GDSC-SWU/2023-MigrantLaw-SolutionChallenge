...
//
//     final searchWage = searchWageFromJson(jsonString);

import 'dart:convert';

List<SearchWage> searchWageFromJson(String str) => List<SearchWage>.from(json.decode(str).map((x) => SearchWage.fromJson(x)));

String searchWageToJson(List<SearchWage> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class SearchWage {
  ...
  factory SearchWage.fromJson(Map<String, dynamic> json) => SearchWage(
