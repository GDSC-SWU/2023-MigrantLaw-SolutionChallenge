...
import '../service/model/wage_services.dart';

class WageDetailScreen extends StatefulWidget {
  const WageDetailScreen({Key? key}) : super(key: key);

  @override
  State<WageDetailScreen> createState() => _WageDetailScreenState();
}

class _WageDetailScreenState extends State<WageDetailScreen> {
  ...
  static String endPointUrl = API().getWageUrl();
  final Uri url = Uri.parse(endPointUrl);

  late Future<WageServices> services;
  ...
  Future<WageServices> fetchData() async {
    ...
    if (response.statusCode == 200) {
      return WageServices.fromJson(json.decode(response.body));
    } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder<WageServices>(
          future: services,
